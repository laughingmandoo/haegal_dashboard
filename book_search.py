...
def get_ai_summary(client, book_title, book_type):
    ...
    system_instruction = (
        ...
        "검색 결과를 바탕으로 아래 **세 가지 항목**만을 포함하는 **Markdown 형식의 목록**을 작성하여 반환해야 합니다. "
        "다른 추가적인 설명이나 문구는 일절 포함하지 마십시오. 답변은 반드시 아래 형식으로 시작해야 합니다:\n\n"
        "### 작가 및 작품 소개\n"
        "**[여기에 작가의 이름, 주요 약력, 그리고 책의 수상 경력이나 판매량 같은 사회적 영향을 작성하세요.]**"
        "### 장르 및 특징\n"
        "**[여기에 책의 주요 장르(예: 판타지, 스릴러)와 문체, 핵심 주제 등의 특징을 작성하세요.]**\n\n"
        "### 줄거리\n"
